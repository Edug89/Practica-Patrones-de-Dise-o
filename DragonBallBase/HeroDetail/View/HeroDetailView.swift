...
class HeroDetailView: UIView {
    ...
    let photoImageView = {
        ...
        imageView.translatesAutoresizingMaskIntoConstraints = false //Debe ir siempre añadido a lo que queramos añadir es olbigatorio para que muestre.
        return imageView
    }()
...
//            descriptionLabel.heightAnchor.constraint(equalToConstant: 60),
    ...
    func configure(_  model: HeroModel) { //Esta función es llamada desde la tabla de dataSource
